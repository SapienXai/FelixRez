...
export function Footer() {
  ...
  const socialLinks = [
    ...
    {
      name: "Instagram",
      url: "https://www.instagram.com/felixmarmaris/",
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      name: "TikTok",
      url: "https://www.tiktok.com/@felix.marmaris",
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      name: "Facebook",
      url: "https://www.facebook.com/felixbeachmarmaris",
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
